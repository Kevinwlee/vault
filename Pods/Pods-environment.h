...
// CarbonBlack
#define COCOAPODS_POD_AVAILABLE_CarbonBlack
#define COCOAPODS_VERSION_MAJOR_CarbonBlack 0
#define COCOAPODS_VERSION_MINOR_CarbonBlack 0
#define COCOAPODS_VERSION_PATCH_CarbonBlack 2
